            ...
            <li class="nav-item">
                ...
                <div id="project" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('project.create') }}">Create Project info</a>
                        <a class="collapse-item" href="{{ route('project.manage') }}">Manage Project</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="{{ route("contact.manage") }}">Read More Messages</a>
                            </div>
                        </li>
